...
//	
//	@Pointcut("execution(* com.example.sso.*.*(..))")
...
//		log.info("Inside " + className + " class " + methodName + " method , with request : "
//				+ mapper.writeValueAsString(array));
//		Object response = pj.proceed();
//
//		log.info("Inside " + className + " class " + methodName + " method , with response : "
